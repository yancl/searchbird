...
class SearchbirdServiceConfig extends ServerConfig[SearchbirdService.ThriftServer] {
  ...
  var tracerFactory: Tracer.Factory = ZipkinTracer(scribeHost="127.0.0.1", scribePort=1463, sampleRate=1.0f)
  //for debug only
  //var tracerFactory: Tracer.Factory = ConsoleTracer.factory
